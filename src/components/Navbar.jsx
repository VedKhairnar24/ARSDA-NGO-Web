      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex h-14 sm:h-16 items-center justify-between">
          <Link to="/" className="flex items-center gap-2" aria-label="ARSDA Home">
            ...
            <span className="text-base sm:text-lg font-semibold text-gray-900">ARSDA</span>
          </Link>
        ...
        {isMenuOpen && (
          <div className="lg:hidden border-t border-gray-200 bg-white">
            <nav className="px-4 py-4 space-y-3">
              <NavLink 
                to="/" 
                className={`block px-3 py-2 text-sm rounded-md ${({isActive}) => isActive ? 'text-teal-600 bg-teal-50' : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'}`}
