  ...
  return (
    <div className="py-16">
      <div className="max-w-4xl mx-auto px-6 animate-fade-in-up">
        <h1 className="text-3xl font-light text-gray-900 mb-8">Our Programs</h1>
        <div className="space-y-10">
          {/* Services & Training Programs */}
          <section className="animate-fade-in-up">
            <h2 className="text-xl font-light text-gray-900 mb-3">Services & Training Programs</h2>
          ...
          <section className="animate-fade-in-up animation-delay-200">
            <h2 className="text-xl font-light text-gray-900 mb-3">Counselling and Outreach</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
          ...
          <section className="animate-fade-in-up animation-delay-400">
            <h2 className="text-xl font-light text-gray-900 mb-3">Health & Welfare Programs</h2>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
          ...
          <section className="animate-fade-in-up animation-delay-600">
            <h2 className="text-xl font-light text-gray-900 mb-3">Long-Term Goals (Future Development)</h2>
            <p className="text-gray-700 mb-2">We aim to establish or collaborate with:</p>
            <ul className="list-disc list-inside space-y-2 text-gray-700">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-4">
              <img src="../images/Yoga program.jpg" alt="Yoga program" className="w-full h-56 object-cover rounded-lg border border-gray-200 hover-lift" />
              <img src="../images/helth check.jpg" alt="Community program" className="w-full h-56 object-cover rounded-lg border border-gray-200 hover-lift" />
            </div>
          </section>
        </div>
      </div>
